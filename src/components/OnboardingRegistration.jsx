  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center p-3 py-10 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-0 left-1/3 w-80 h-80 bg-purple-500 rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-blob"></div>
        <div className="absolute bottom-0 right-1/3 w-80 h-80 bg-indigo-500 rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-blob animation-delay-2000"></div>
      </div>

      <div className="relative w-full max-w-4xl">
        {/* Card */}
        <div className="bg-white/10 backdrop-blur-xl rounded-2xl shadow-xl border border-white/15 p-6 md:p-8 animate-slide-in-up custom-scrollbar overflow-y-auto max-h-[90vh]">
          {/* Header */}
          <div className="text-center mb-8">
            ...
            <p className="text-gray-300 max-w-2xl mx-auto text-sm">
              Join FinAuth today. Fill in your details to get started with
            ...
            <div>
              ...
              <div className="flex gap-2">
                <select
                  ...
                  onChange={handleChange}
                  className="px-3.5 py-3 bg-white/5 border border-white/10 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all duration-200"
                >
                  <option value="+91" className="bg-slate-800">
                    IN (+91)
                  </option>
                ...
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    required
                    className="w-full pl-11 pr-4 py-3 bg-white/5 border border-white/10 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all duration-200 input-glow"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    minLength={8}
                    className="w-full pl-11 pr-11 py-3 bg-white/5 border border-white/10 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all duration-200 input-glow"
